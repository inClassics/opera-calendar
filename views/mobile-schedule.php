<div class="mobile-schedule">
    ...
    <?php foreach ($mobileDays as $day): ?>
                    ...
                    <div>
                        ...
                        <div class="mobile-points-grid">
                            ...
                            <?php foreach ($members as $member): ?>
                                ...
                                <div
                                    class="mobile-point-item <?= $userId === current_user_id() ? 'current-user-mobile' : '' ?>"
                                >
                                    <span>
                                        <?= e($member['name']) ?>
                                    </span>
        ...
        <article
            class="mobile-day-card <?= $day['weekday'] === 'Sunday' ? 'mobile-week-end' : '' ?>"
        >
                ...
                <?php foreach (
                    ...
                    <section class="mobile-session">
                        ...
                        <?php foreach ($periodEvents as $event): ?>
                            ...
                            <div
                                class="mobile-event-block <?= $eventId ? 'is-split-event' : '' ?>"
                            >
