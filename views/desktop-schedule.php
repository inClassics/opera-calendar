...
function desktopPaperPointEditor(array $pointItem): void
{
    ...
    $pointType = $pointItem['point_type'] ?? '';
?>
    <div
...
function desktopPaperPointBadge(?array $pointItem): void
{
    ...
    $label = $pointType === 'rehearsal' ? 'Rehearsal' : 'Performance';
?>
    <div
    ...
    >
        <span class="desktop-paper-point-letter"><?= e($letter) ?></span>
                                        ...
                                        <div class="desktop-paper-activity-item">
                                            <span class="desktop-paper-activity-text">
                                                <?php if ($displayActivity === ''): ?>
                                                    <span class="desktop-paper-activity-empty">—</span>
                                                <?php elseif (
                                            ...
                                            <?php desktopPaperPointBadge($pointItem); ?>

                                            <?php
                                            if ($pointItem) {
                                                desktopPaperPointEditor($pointItem);
                                            }
                                            ?>
                                        </div>
                                    <?php endforeach; ?>
...
<div class="desktop-schedule desktop-paper-schedule">
    <?php foreach ($desktopWeeks as $week): ?>
        ...
        <article class="desktop-paper-week">
            ...
            /*
            | Top roster:
            | physical morning availability + rehearsal totals.
            */
            ...
            /*
            | Bottom roster:
            | physical evening availability + performance totals.
            */
            desktopPaperRenderRoster(
                'evening',
                $week,
