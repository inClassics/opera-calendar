        ...
        <div class="user-list">
            <?php foreach ($users as $user): ?>
                <form class="user-row" method="post">
                    ...
                    <label>Role<select name="role"><option value="member" <?= $user['role'] === 'member' ? 'selected' : '' ?>>Member</option><option value="admin" <?= $user['role'] === 'admin' ? 'selected' : '' ?>>Admin</option></select></label>
